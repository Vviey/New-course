const i=[{id:101,title:"The Central Citadel",subtitle:"Introduction to Centralized Monetary Systems",description:"Learn about centralized control, surveillance, privacy, and digital currencies in modern financial systems.",simulationType:"surveillance",content:`
    ...
    `},{id:102,title:"Financial Surveillance: The Digital Lens",subtitle:"Introduction to financial surveillance and privacy concerns",description:"Learn the fundamentals of financial surveillance, its real-world applications, and why privacy matters.",simulationType:"surveillance",content:`
    ...
    `},{id:103,title:"The Citadel's Shadows",subtitle:"Understanding financial surveillance",description:"Learn how centralized monetary systems enable surveillance and financial control.",simulationType:"surveillance",content:`
      <div style="position: relative; background-color: rgba(255, 204, 0, 0.05); border-radius: 12px; padding: 20px; margin-bottom: 24px; overflow: hidden;">
        <div style="position: absolute; top: 0; right: 0; width: 150px; height: 150px; background: radial-gradient(circle at top right, rgba(255, 204, 0, 0.2), transparent 70%); z-index: 0;"></div>
    ...
    `},{id:104,title:"Privacy vs Control",subtitle:"Balancing transparency and personal privacy",description:"Explore the balance between financial transparency and personal privacy.",simulationType:"privacy",content:`
      <div style="background-color: rgba(255, 204, 0, 0.1); border-radius: 8px; padding: 20px; margin-bottom: 24px;">
      <img src="https://bitcoiners.africa/wp-content/uploads/2025/06/Realm-2-The-Citadel-Shados.png" 
        alt="Everyday Bitcoin Tools" 
        style="position: relative; z-index: 1; width: 100%; height: 200px; object-fit: cover; border-radius: 8px; margin-bottom: 16px;">
    ...
    `},{id:105,title:"CBDCs and Privacy",subtitle:"The future of government-issued digital money",description:"Understand how Central Bank Digital Currencies might affect financial privacy.",simulationType:"cbdc",content:`
      <div style="background-color: rgba(255, 204, 0, 0.1); border-radius: 8px; padding: 20px; margin-bottom: 24px;">
    ...
    `},{id:106,title:"Bitcoin's Transparency",subtitle:"Balancing public ledgers with pseudonymity",description:"Discover how Bitcoin balances transparency with pseudonymity.",simulationType:"bitcoin",content:`
    ...
    `},{id:107,title:"Self-Custody",subtitle:"Taking control of your financial sovereignty",description:'Explore why "not your keys, not your coins" matters for financial sovereignty.',simulationType:"selfcustody",content:`
      <div style="background-color: rgba(255, 204, 0, 0.1); border-radius: 8px; padding: 20px; margin-bottom: 24px;">
