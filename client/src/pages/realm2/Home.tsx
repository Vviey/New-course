...
// Surveillance City - Realm 2 Home Page
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-black">
        <div className="text-center">
          ...
          <h3 className="text-xl font-medium text-purple-500">Loading Surveillance City...</h3>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black text-white py-8 px-4 sm:px-6 lg:px-8" 
      ...
      <div className="max-w-5xl mx-auto">
        <div className="backdrop-blur-md bg-black/60 rounded-xl p-6 mb-8 border border-purple-900/50">
          <h1 className="text-4xl font-bold text-purple-500 mb-2">Surveillance City</h1>
          <p className="text-xl text-purple-200 mb-6">Realm 2: Where Privacy Meets Control</p>
          
          <p className="text-gray-300 mb-4">
            Welcome to the Citadel, a walled city-state where every transaction is monitored, every purchase is tracked, 
