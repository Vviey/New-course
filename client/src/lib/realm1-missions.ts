...
export const realm1Missions: MissionContent[] = [
  {
    ...
    description: "\"Asha, before we continue our journey,\" Odu explained as they walked along a busy village market, \"we must understand how trade began. Look around at all these goods being exchanged. Long ago, before coins or paper money existed, people simply traded goods directly—this is called bartering.\"\n\nIn this mission, you'll explore the ancient practice of bartering, the earliest form of economic exchange before the invention of money. Across Africa, communities developed sophisticated barter networks, exchanging valuable goods like salt from the Sahara, gold from West Africa, textiles from Ethiopia, and copper from Central Africa.\n\nAsking you to observe closely, Odu points out: \"See how that woman is offering her clay pots in exchange for grain? That's bartering. It works well when both parties want what the other has.\"\n\nHowever, barter had major limitations. Imagine you have fish but need tools - if the toolmaker doesn't want fish, you're stuck! This 'double coincidence of wants' problem made trade inefficient. Additionally, how do you divide a cow if you only need a small amount of grain? These challenges eventually led societies to develop intermediate commodities that everyone accepted - the first forms of money.\n\n\"Think about it this way,\" Odu smiles, \"What would you do if you had extra beans but needed new sandals, and the sandal maker only wanted fish? You would need to find someone with fish who wanted your beans, then take that fish to the sandal maker! That's why people eventually created things that everyone would accept in trade.\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"After people realized the problems with direct bartering,\" Odu continued as he guided Asha through a museum-like space filled with historical artifacts, \"they began using special items that everyone valued. Look at these cowrie shells—they were one of Africa's first forms of money.\"\n\nOdu held up a beautiful cream-colored shell. \"These were perfect as money because they were scarce, durable, and couldn't be easily copied. Across Africa, from the great kingdoms of West Africa to the coastal settlements of East Africa, these tiny shells facilitated trade for centuries.\"\n\nTrace the fascinating journey of how money evolved from commodity money like shells and beads to the first standardized metal coins. Understand why certain items became widely accepted as forms of value exchange.\n\n\"Money needed to be something everyone agreed had value,\" Odu explained. \"It couldn't be something too common, or it would be worthless. It couldn't spoil quickly like food. And it needed to be easy to carry. Over time, people realized metals like gold and silver made excellent money—they were rare, didn't rust or decay, could be divided into smaller pieces, and could be verified as real by their weight and appearance.\"\n\nOdu pulled out a small gold coin. \"This is where the story leads—standardized pieces of metal, with marks that guaranteed their value. With these coins, trade could happen more easily across vast distances, between people who didn't even speak the same language!\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"Money's value isn't always constant,\" Odu told Asha as they walked through a marketplace. He pointed to an elderly woman selling vegetables. \"Ask that vendor about prices when she was young.\"\n\nAsking, Asha learned that bread once cost a fraction of today's price. \"This is inflation,\" Odu explained. \"When money loses value over time, prices rise. Imagine if your savings today only bought half as much food next year—that's the danger of inflation.\"\n\nExperience how the value of money can change over time through inflation. This simulation will show you how prices of everyday items have increased throughout history and what causes these changes.\n\n\"Money is supposed to store value over time,\" continued Odu. \"But when too much money is created, each unit becomes worth less. Think of it like this: if only 10 special shells existed in a village, each would be valuable. But if suddenly 1,000 identical shells were discovered, each shell would become less special—less valuable.\"\n\nOdu showed Asha historical images of hyperinflation in Zimbabwe, where prices doubled daily at one point, forcing people to carry billions of Zimbabwe dollars just to buy bread. \"When money fails like this, people lose trust in it. Some African nations experienced this when their governments printed too much money.\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"Not all forms of money are created equal,\" Odu explained as he and Asha examined various historical currencies displayed behind glass cases. \"Some work better than others. Let me show you why.\"\n\nOdu pointed to each display in turn. \"Good money needs specific qualities to function well. Think about salt as money—it was valuable, but it could dissolve in rain or humidity! Gold doesn't have that problem—it's durable. But what if you need to make a small purchase with a large gold bar? That's why divisibility matters.\"\n\nTest your knowledge about the key properties that make good money. Different forms of money throughout history have succeeded or failed based on these essential characteristics.\n\n\"Let me share a simple way to remember the qualities of good money,\" Odu suggested. \"Think of the word 'DUPSVF': Durable (doesn't break down), Uniform (each piece is the same), Portable (easy to carry), Scarce (limited supply), Verifiable (can't be counterfeited), and Fungible (interchangeable units).\"\n\nOdu smiled as he continued, \"Throughout history, people discovered these properties through trial and error. Cowrie shells worked in Africa because they were naturally scarce and hard to counterfeit. Salt worked until humidity affected it. Paper money works only if people trust that it's limited and backed by something valuable.\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"The greatest achievement of money,\" Odu proclaimed as he and Asha stood before an enormous map of Africa with glowing trade routes, \"was how it connected entire continents through trade!\"\n\nOdu traced a golden line that stretched from Mali across the Sahara. \"This is the famous gold route. Without standardized money, traders would need to carry heavy goods everywhere they went. But with gold coins and cowrie shells, a merchant from Timbuktu could travel to Egypt carrying only a small pouch of currency.\"\n\nExplore ancient African trade routes and see how the introduction of standardized forms of money facilitated trade across vast distances. Navigate through historical trading posts and make strategic decisions to maximize your trading success.\n\n\"Africa had some of the world's most sophisticated trade networks,\" Odu continued enthusiastically. \"The kingdom of Mali became extraordinarily wealthy through gold trade. The East African coastal cities like Kilwa grew prosperous as trading hubs connecting Africa to Asia. And all of this was possible because money solved the 'double coincidence of wants' problem we saw with barter.\"\n\nAs they examined the intricate web of routes, Odu explained, \"Think about it—a trader carrying salt from the Sahara could sell it for cowrie shells in one market, then use those shells to buy ivory in another, and finally exchange that for textiles elsewhere. Money made this chain of trade possible without needing direct exchanges.\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"Money isn't the only way communities organize their resources,\" Odu said as they entered a circular village clearing where people were working together. \"Here in Africa, we developed something profound—an economic system based on Ubuntu.\"\n\n\"What's Ubuntu?\" Asha asked, watching villagers exchanging labor and items without any currency changing hands.\n\n\"It means 'I am because we are,'\" Odu explained. \"It's a philosophy that recognizes our interconnectedness. In many African communities, economic decisions weren't just about profit, but about collective wellbeing.\"\n\nExplore how African societies developed sophisticated economic systems based on trust and communal values rather than relying solely on currency. Discover the philosophy of Ubuntu ('I am because we are') and its applications in community resource management throughout African history.\n\nOdu showed how a family was helping build another's home without payment. \"They know when they need help, others will come to their aid too. This creates resilience—if your crops fail, the community ensures you don't starve. If you need labor for a big project, the community provides it. These systems existed alongside trade and money, creating a balanced approach to economics.\"\n\n\"Modern economics often ignores these systems,\" Odu noted, \"but they've sustained communities for centuries, especially during hardships when money systems collapsed.\"",
    objectives: [
  ...
  },
  {
    ...
    description: "\"As we complete our journey through the Realm of Origins,\" Odu told Asha as they stood before a museum-like collection of historical currency, \"let's examine how Africa's monetary systems evolved through the ages.\"\n\nAsha marveled at the display cases filled with everything from cowrie shells to gold dust, copper crosses, and colonial-era coins. \"Before European colonization,\" Odu explained, \"African kingdoms had sophisticated currency systems. The Akan people of West Africa used carefully weighed gold dust for trade. In Central Africa, copper crosses served as currency. These weren't primitive—they were perfectly adapted to local conditions.\"\n\nExplore the rich history of money and currency systems throughout African history. Learn how different cultures and communities developed unique monetary systems and how these evolved over time in response to local conditions and external forces.\n\n\"Colonization disrupted these systems,\" Odu continued with a note of sadness. \"European powers imposed their currencies, often to facilitate resource extraction and tax collection. This fundamentally changed economic relationships.\"\n\nOdu traced the timeline to independence. \"When African nations gained independence, creating their own currencies became a symbol of sovereignty. However, many faced challenges of inflation and instability. Today, innovations like mobile money are creating new possibilities for African monetary systems, building on both traditional values and modern technology.\"",
    objectives: [
